...
<head>
    ...
    <!-- Favicon -->
    <link href="{{ asset('forntend_assets') }}/img/favicon.ico" rel="icon">
    ...
    <link href="{{ asset('forntend_assets') }}/lib/owlcarousel/assets/owl.carousel.min.css" rel="stylesheet">

    <!-- Customized Bootstrap Stylesheet -->
    <link href="{{ asset('forntend_assets') }}/css/style.css" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="{{ asset('forntend_assets') }}/lib/easing/easing.min.js"></script>
    <script src="{{ asset('forntend_assets') }}/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="{{ asset('forntend_assets') }}/mail/jqBootstrapValidation.min.js"></script>
    <script src="{{ asset('forntend_assets') }}/mail/contact.js"></script>

    <!-- Template Javascript -->
    <script src="{{ asset('forntend_assets') }}/js/main.js"></script>
</body>
